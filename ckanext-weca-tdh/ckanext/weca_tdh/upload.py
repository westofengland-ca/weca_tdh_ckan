...
def verify_file(filename, file_size):
    # get file extension
...
class BlobStorage():
    ...
    def upload_blob(file, filename):
        ...
        blob_client = BlobStorage.get_blob_service_client().get_blob_client(container=C.TDH_UPLOAD_STORAGE_CONTAINER, blob=filename)
        blob_client.upload_blob(file)

    def create_signiture_file(file_path, data):
        with open(file_path, 'w') as file:
            json.dump(data, file)

    def call_http_trigger(body):
    ...
    def post(self, id: str, resource_id: str):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try: 
                ...
                BlobStorage.create_signiture_file(f"{temp_dir}/info.json", upload_info)
                ...
                try:
                    ...
                    BlobStorage.call_http_trigger(upload_info)
    ...
    def _prepare(self, id: str, resource_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            return toolkit.abort(
                403, ("User %r not authorized to edit %s") % (user, id)
            )
